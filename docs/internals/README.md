...
| [`judgement-floor.md`](judgement-floor.md) | The seven irreducible judgement points where a deterministic primitive abstains and hands a choice back to the caller — the measured boundary of "automagic." Anchored to the `decisions` contract and the `count_llm_touchpoints` meter. Read to understand what the agentic glue is *for* and what the ratchet drives toward. |
