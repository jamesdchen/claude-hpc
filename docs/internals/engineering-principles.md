...
| Q3: standalone files don't import the package | `tests/contracts/test_boundary_contract.py`, `scripts/lint_schema_versions.py`, `execution/mapreduce/_guard.py` | templates/standalone files reference the core package; schema constants drift |
